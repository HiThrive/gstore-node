...
class Query {
    ...
    initQuery(namespace, transaction) {
        ...
        const enhancedQueryRun = (options, responseHandler = (res) => res) => {
            options = (0, extend_1.default)(true, {}, this.Model.schema.options.queries, options);
            /**
            ...
            const populateHandler = (response) => refsToPopulate.length
                ? this.Model.__populate(refsToPopulate, options)(response.entities).then((entitiesPopulated) => ({
                    ...response,
                    entities: entitiesPopulated,
                }))
                : response;
    ...
    list(options = {}) {
        ...
        if ({}.hasOwnProperty.call(this.Model.schema.shortcutQueries, 'list')) {
            options = (0, extend_1.default)({}, this.Model.schema.shortcutQueries.list, options);
        }
